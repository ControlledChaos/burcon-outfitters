...
class Settings_Page_Scripts {
    ...
    public function settings_page() {
		...
		$this->page_help_section = add_options_page(
			__( 'Script Options', 'burcon-outfitters' ),
			__( 'Script Options', 'burcon-outfitters' ),
			'manage_options',
			BURCON_ADMIN_SLUG . '-scripts',
			[ $this, 'page_output' ]
		);
    ...
    public function page_help_section() {
		...
		$screen->add_help_tab( [
			'id'       => 'inline_scripts',
			'title'    => __( 'Inline Scripts', 'burcon-outfitters' ),
			'content'  => null,
		...
		$screen->add_help_tab( [
			'id'       => 'inline_jquery',
			'title'    => __( 'Inline jQuery', 'burcon-outfitters' ),
			'content'  => null,
		...
		$screen->add_help_tab( [
			'id'       => 'remove_emoji',
			'title'    => __( 'Emoji Script', 'burcon-outfitters' ),
			'content'  => null,
    ...
    public function page_help_section_sidebar() {
		...
		$html = '<ul>
			<li><a href="https://github.com/kenwheeler/slick" target="_blank" style="text-decoration: none;">' . __( 'Slick on GitHub', 'burcon-outfitters' ) . '</a></li>
			<li><a href="https://github.com/vdw/Tabslet" target="_blank" style="text-decoration: none;">' . __( 'Tabslet on GitHub', 'burcon-outfitters' ) . '</a></li>
			<li><a href="https://github.com/leafo/sticky-kit" target="_blank" style="text-decoration: none;">' . __( 'Sticky-kit on GitHub', 'burcon-outfitters' ) . '</a></li>
			<li><a href="https://github.com/iamceege/tooltipster" target="_blank" style="text-decoration: none;">' . __( 'Tooltipster on GitHub', 'burcon-outfitters' ) . '</a></li>
		</ul>';
