...
class Admin_Toolbar_Menus {
	...
	public function register() {
		...
		register_nav_menus(
			[
			'burcon_admin_toolbar_site'       => esc_html__( 'Admin Toolbar: Site Name', 'burcon-outfitters' ),
			'burcon_admin_toolbar_main'       => esc_html__( 'Admin Toolbar: Main', 'burcon-outfitters' ),
			'burcon_admin_toolbar_account'    => esc_html__( 'Admin Toolbar: My Account', 'burcon-outfitters' ),
			'burcon_frontend_toolbar_site'    => esc_html__( 'Frontend Toolbar: Site Name', 'burcon-outfitters' ),
			'burcon_frontend_toolbar_main'    => esc_html__( 'Frontend Toolbar: Main', 'burcon-outfitters' ),
			'burcon_frontend_toolbar_account' => esc_html__( 'Frontend Toolbar: My Account', 'burcon-outfitters' )
			]
		);
