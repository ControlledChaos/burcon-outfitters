...
<div>
	<h3><?php _e( 'Inline jQuery', 'burcon-outfitters' ); ?></h3>
	<p><?php _e( 'Choose whether to deregister the jQuery that is included with WordPress then add it as inline script in the footer.' ); ?></p>
