...
<!-- Dublin Core meta -->
<meta name="DC.Title" content="<?php do_action( 'burcon_meta_title_tag' ); ?>" />
<meta name="DC.Format" content="text/html" />
<meta name="DC.Identifier" content="<?php do_action( 'burcon_meta_url_tag' ); ?>"/>
...
<?php else : ?>
<meta name="DC.Description" content="<?php do_action( 'burcon_meta_description_tag' ); ?>" />
<?php endif; ?>
<meta name="DC.Creator" content="<?php echo get_bloginfo( 'name' ); ?>" />
<?php if ( is_singular() ) : ?>
<meta name="DC.Contributor" content="<?php do_action( 'burcon_meta_author_tag' ); ?>" />
<?php endif; ?>
<?php if ( is_single() ) : ?>
<meta name="DC.Date" content="<?php echo get_the_date(); ?>" />
<?php endif; ?>
<meta name="DC.Publisher" content="<?php echo get_bloginfo( 'name' ); ?>" />
<meta name="DC.Rights" content="<?php echo sprintf( '© Copyright %1s %2s. %3s.', get_the_time( 'Y' ), get_bloginfo( 'name' ), esc_attr__( 'All rights reserved', 'burcon-outfitters' ) ); ?>" />
